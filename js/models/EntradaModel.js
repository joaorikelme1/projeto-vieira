/** @module EntradaModel — income record structure */
const EntradaModel = (() => {
  const TIPOS = ['venda','pix','cartao','dinheiro'];
  ...
  function update(existing, changes) {
    return {
      ...
      tipo:        changes.tipo      !== undefined ? changes.tipo      : existing.tipo,
